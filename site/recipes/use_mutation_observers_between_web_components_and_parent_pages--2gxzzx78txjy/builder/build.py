...
class Builder():
    ...
    def wrap_escapes(self):
        ...
        if self.parts['JAVASCRIPT2'] != '':
            self.parts['ESCAPED_JAVASCRIPT2'] = f'''
            <h2>JavaScript Main Page</h2>
            <pre><code class="language-js">{escape(self.parts['JAVASCRIPT2'])}</code></pre>
            '''
...
if __name__ == "__main__":
    b = Builder()
    b.content_files = ['HTML.html', 'HEAD.html', 'JAVASCRIPT.js', 'JAVASCRIPT2.js', 'CSS.css', 'TEMPLATE.html']
    b.load_config()
    b.load_parts()
    b.escape_parts()
    b.load_details()
